function varargout = soundprefs_guid(varargin)
%% soundprefs_gui.m
...
if nargin
    ...
    randOrd = varargin{3};
    TotalTrials = varargin{4};
    CurrentTrialNumber = varargin{5};
end
...
function saveData(playTimeA, playTimeB, CurrentTrialNumber)
    ...
    varargout = {A_times, B_times, A_sumtimes, B_sumtimes, TrialTimes};


    
    % uiwait(intimagewh)
    % uiwait(initmenuh)
    clear playTimeA playTimeB A_times B_times
    close all;
